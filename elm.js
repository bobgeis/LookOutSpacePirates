var Elm = Elm || { Native: {} };
Elm.Asteroids2 = Elm.Asteroids2 || {};
Elm.Asteroids2.make = function (_elm) {
   "use strict";
   _elm.Asteroids2 = _elm.Asteroids2 || {};
   if (_elm.Asteroids2.values)
   return _elm.Asteroids2.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Asteroids2",
   ...
   var drawVesselPane = F2(function (vessel,
   xy) {
      return $Graphics$Collage.move(xy)($Graphics$Collage.toForm($Graphics$Element.opacity(0.8)($Graphics$Element.color($Color.darkBlue)($Graphics$Element.flow($Graphics$Element.right)(_L.fromArray([A3($Graphics$Element.image,
                                                                                                                                                                                                      20,
                                                                                                                                                                                                      20,
                                                                                                                                                                                                      vessel.image)
                                                                                                                                                                                                      ,drawText(A2($Basics._op["++"],
                                                                                                                                                                                                      " Shields: ",
                                                                                                                                                                                                      $Basics.toString($Basics.floor(vessel.shields.cur))))
                                                                                                                                                                                                      ,drawText(A2($Basics._op["++"],
                                                                                                                                                                                                      " Blinks: ",
                                                                                                                                                                                                      $Basics.toString($Basics.floor(vessel.blinks.cur))))
                                                                                                                                                                                                      ,drawText(A2($Basics._op["++"],
                                                                                                                                                                                                      " Beams: ",
                                                                                                                                                                                                      $Basics.toString($Basics.floor(vessel.beam.cur))))
                                                                                                                                                                                                      ,drawText(A2($Basics._op["++"],
                                                                                                                                                                                                      " Torps: ",
                                                                                                                                                                                                      $Basics.toString($Basics.floor(vessel.torp.cur))))]))))));
   });
   var viewVessel = F2(function (game,
   vessel) {
      return function () {
         var d = $Basics.floor(vessel.r * 2);
         var $ = game.camera,
         cx = $._0,
         cy = $._1;
         var x = vessel.x - cx;
         ...
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: x
                                       ,_1: y})($Graphics$Collage.rotate(vessel.a - $Basics.degrees(90))($Graphics$Collage.toForm(A3($Graphics$Element.image,
         d,
         d,
         vessel.image))));
      }();
   });
   var viewVessels = function (game) {
      return $Graphics$Collage.group($List.map(viewVessel(game))($Dict.values(game.vessels)));
   };
   var viewTorpedoes = function (game) {
      return function () {
         var torpAll = $List.concatMap(function (_) {
            return _.seekedBy;
         })($Dict.values(game.vessels));
         var $ = game.camera,
         cx = $._0,
         cy = $._1;
         var torpDraw = function (torp) {
            return function () {
               var ageMod = A2($Basics._op["%"],
               $Basics.floor(torp.age * 10),
               4);
               var $ = _U.eq(ageMod,
               0) ? {ctor: "_Tuple2"
                    ,_0: $Color.white
               ...
               3) ? {ctor: "_Tuple2"
                    ,_0: $Color.lightBlue
                    ,_1: 2.5} : _U.badIf($moduleName,
               "between lines 1272 and 1275"),
               color = $._0,
               radius = $._1;
               return $Graphics$Collage.move({ctor: "_Tuple2"
                                             ,_0: torp.x - cx
                                             ,_1: torp.y - cy})($Graphics$Collage.filled(color)($Graphics$Collage.circle(radius)));
            }();
         };
         return $Graphics$Collage.group($List.map(torpDraw)(torpAll));
      }();
   };
   var viewPlanet = function (game) {
      return function () {
         var d = 100;
         var img = "images/3D_Neptune2.png";
         var $ = game.camera,
         cx = $._0,
         cy = $._1;
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: 0 - cx
                                       ,_1: 0 - cy})($Graphics$Collage.toForm(A3($Graphics$Element.image,
         d,
         d,
         img)));
      }();
   };
   var collectEphemera = function (game) {
      return function () {
         var children = $List.map(function (_) {
            return _.children;
         })($Dict.values(game.vessels));
         var newBooms = A2($List.concatMap,
         function (_) {
            return _.booms;
         },
         children);
         var newFlashes = A2($List.concatMap,
         function (_) {
            return _.flashes;
         },
         children);
         var newBeams = A2($List.concatMap,
         function (_) {
            return _.beams;
         },
         children);
         var ephemera = game.ephemera;
         var ephemera$ = _U.replace([["booms"
                                     ,A2($Basics._op["++"],
                                     ephemera.booms,
                                     newBooms)]
                                    ,["flashes"
                                    ...
                                    ,["beams"
                                     ...
                                     newBeams)]],
         ephemera);
         return _U.replace([["ephemera"
                            ,ephemera$]],
         game);
      }();
   };
   var createBeam = F2(function (obj1,
   obj2) {
      return function () {
         var miss = {_: {}
                    ,age: 0
                    ,end: {ctor: "_Tuple2"
                          ,_0: obj1.x + 3 * (obj2.x - obj1.x)
                          ,_1: obj1.y + 3 * (obj2.y - obj1.y)}
                    ,start: {ctor: "_Tuple2"
                            ,_0: obj1.x
                            ,_1: obj1.y}};
         var hit = {_: {}
   ...
   var attachTorpedoes = F2(function (_v0,
   vessels) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "Just":
                    return function () {
                         var vessel$ = _U.replace([["seekedBy"
                                                   ,A2($List._op["::"],
                                                   _v0._1,
                                                   _v4._0.seekedBy)]],
                         _v4._0);
                    ...
                    case "Nothing": return vessels;}
                 _U.badCase($moduleName,
                 "between lines 998 and 1002");
              }();}
         _U.badCase($moduleName,
         "between lines 998 and 1002");
      }();
   });
   var createFlash = F2(function (_v6,
   r) {
      return function () {
         switch (_v6.ctor)
         {case "_Tuple2": return {_: {}
                                 ...
                                 ,y: _v6._1};}
         _U.badCase($moduleName,
         "on line 943, column 6 to 46");
      }();
   });
   var getAng = function (_v10) {
      return function () {
   ...
   var distance = F2(function (obj1,
   obj2) {
      return $Basics.sqrt(Math.pow(obj1.x - obj2.x,
      2) + Math.pow(obj1.y - obj2.y,
      2));
   });
   var accObj = F3(function (t,
   acc,
   obj) {
      return function () {
         var vec = getVec(obj.a);
         var vxDel = vec.x * t * acc;
         var vyDel = vec.y * t * acc;
   ...
   var dragObj = F2(function (t,
   obj) {
      return function () {
         var damp = 1 - obj.drag * t;
         return _U.replace([["vx"
                            ,obj.vx * damp]
                           ,["vy",obj.vy * damp]],
         obj);
   ...
   var wrapAngle = function (a) {
      return _U.cmp(a,
      $Basics.pi) > 0 ? a - 2 * $Basics.pi : _U.cmp(a,
      0 - $Basics.pi) < 0 ? a + 2 * $Basics.pi : a;
   };
   var rotObj = F3(function (t,
   va,
   obj) {
      return _U.replace([["a"
                         ,wrapAngle(obj.a + va * t)]],
      obj);
   });
   var turnTowards = F2(function (obj1,
   obj2) {
      return _U.cmp(wrapAngle(A2(faceObj,
      obj1,
      obj2) - obj1.a),
      0) > 0 ? 1 : -1;
   });
   var getVessel = F2(function (game,
   id) {
      return A2($Dict.get,
      id,
      game.vessels);
   });
   var maybeGetVessel = F2(function (game,
   maybeID) {
      return function () {
         switch (maybeID.ctor)
         {case "Just":
         ...
         _U.badCase($moduleName,
         "between lines 669 and 671");
      }();
   });
   var updateCamera = function (game) {
      return function () {
         var camera$ = function () {
            var _v14 = A2(getVessel,
            game,
            game.playerID);
            switch (_v14.ctor)
            {case "Just":
   ...
   var viewText = function (game) {
      return function () {
         ...
         {case "Just":
            ...
            case "Nothing":
            return $Graphics$Collage.toForm($Graphics$Element.opacity(0.8)($Graphics$Element.color($Color.darkBlue)(drawText(" You have died. So it goes. "))));}
         _U.badCase($moduleName,
         "between lines 1341 and 1346");
      }();
   };
   var quickRange = function ($float) {
      return $Basics.fst($Random.generate(A2($Random.$float,
      -1,
      1))($Random.initialSeed($Basics.floor($float))));
   };
   var blinkJump = function (_v18) {
      return function () {
         switch (_v18.ctor)
         {case "_Tuple2":
            return function () {
                 var vec = getVec(quickRange(_v18._0 * _v18._1 * 4) * $Basics.pi);
                 return {ctor: "_Tuple2"
                        ,_0: _v18._0 + vec.x * 80
                        ,_1: _v18._1 + vec.y * 80};
              }();}
         _U.badCase($moduleName,
         "between lines 935 and 938");
      }();
   };
   var quickProb = function ($float) {
      return $Basics.fst($Random.generate(A2($Random.$float,
      0,
      1))($Random.initialSeed($Basics.floor($float))));
   };
   var flashInitRadius = 20;
   var flashShrinkRate = 20;
   var flashMaxAge = 0.3;
   var viewFlashes = function (game) {
      return function () {
         var $ = game.camera,
         cx = $._0,
         cy = $._1;
         var flashDraw = function (flash) {
            return function () {
               var ageRatio = flash.age / flashMaxAge;
               var color = _U.cmp(ageRatio,
               0.4) < 0 ? $Color.white : _U.cmp(ageRatio,
               0.8) < 0 ? $Color.lightBlue : $Color.darkBlue;
               return $Graphics$Collage.move({ctor: "_Tuple2"
                                             ,_0: flash.x - cx
                                             ,_1: flash.y - cy})($Graphics$Collage.filled(color)($Graphics$Collage.circle(flash.r)));
            }();
         };
         return $Graphics$Collage.group($List.map(flashDraw)(game.ephemera.flashes));
      }();
   };
   var boomInitRadius = 12;
   var createBoom = function (obj) {
      return {_: {}
             ,a: 0
             ,age: 0
             ,drag: 0
   ...
   var boomGrowthRate = 120;
   var boomMaxAge = 0.15;
   var viewBooms = function (game) {
      return function () {
         var $ = game.camera,
         cx = $._0,
         cy = $._1;
         var boomDraw = function (boom) {
            return function () {
               var ageRatio = boom.age / boomMaxAge;
               var color = _U.cmp(ageRatio,
               ...
               return $Graphics$Collage.move({ctor: "_Tuple2"
                                             ,_0: boom.x - cx
                                             ,_1: boom.y - cy})($Graphics$Collage.filled(color)($Graphics$Collage.circle(boom.r)));
            }();
         };
         return $Graphics$Collage.group($List.map(boomDraw)(game.ephemera.booms));
      }();
   };
   var beamMaxAge = 0.1;
   var updateEphemera = F2(function (input,
   game) {
      return function () {
         var eph = game.ephemera;
         var t = input.tick;
         var updateBeam = function (beam) {
            return _U.cmp(beam.age,
            beamMaxAge) > 0 ? $Maybe.Nothing : $Maybe.Just(_U.replace([["age"
                                                                       ,beam.age + t]],
            beam));
         };
         var beams$ = A2($List.filterMap,
         updateBeam,
         eph.beams);
         var updateBoom = function (boom) {
            return _U.cmp(boom.age,
            boomMaxAge) > 0 ? $Maybe.Nothing : $Maybe.Just(_U.replace([["age"
                                                                       ,boom.age + t]
                                                                      ,["r"
                                                                       ,boom.r + t * boomGrowthRate]],
            boom));
         };
         var booms$ = A2($List.filterMap,
         updateBoom,
         eph.booms);
         var updateFlash = function (flash) {
            return _U.cmp(flash.age,
            flashMaxAge) > 0 ? $Maybe.Nothing : $Maybe.Just(_U.replace([["age"
                                                                        ,flash.age + t]
                                                                       ,["r"
                                                                        ,flash.r - t * flashShrinkRate]],
            flash));
         };
         var flashes$ = A2($List.filterMap,
         updateFlash,
         eph.flashes);
         var eph$ = _U.replace([["beams"
                                ,beams$]
                               ,["booms",booms$]
                               ,["flashes",flashes$]],
         eph);
   ...
   var viewBeams = function (game) {
      return function () {
         var drawBeam = function (beam) {
            return function () {
               var ageRatio = beam.age / beamMaxAge;
               var $ = _U.cmp(ageRatio,
               0.75) > 0 ? {ctor: "_Tuple2"
                           ,_0: $Color.darkBlue
                           ,_1: 2} : _U.cmp(ageRatio,
               0.5) > 0 ? {ctor: "_Tuple2"
                          ,_0: $Color.lightBlue
                          ,_1: 3} : _U.cmp(ageRatio,
               0.25) > 0 ? {ctor: "_Tuple2"
                           ,_0: $Color.white
                           ,_1: 4} : {ctor: "_Tuple2"
                                     ,_0: $Color.lightBlue
               ...
               color = $._0,
               width = $._1;
               var lineStyle = $Graphics$Collage.solid(color);
               return $Graphics$Collage.traced(_U.replace([["width"
                                                           ,width]],
               lineStyle))(A2($Graphics$Collage.segment,
               beam.start,
               beam.end));
            }();
         };
         var beams = $List.concatMap(function (_) {
            return _.beams;
         })($List.map(function (_) {
            return _.children;
         })($Dict.values(game.vessels)));
         ...
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: 0 - cx
                                       ,_1: 0 - cy})($Graphics$Collage.group($List.map(drawBeam)(game.ephemera.beams)));
      }();
   };
   var Beam = F3(function (a,b,c) {
      return {_: {}
             ,age: c
             ,end: b
             ,start: a};
   });
   var torpDetRadius = 12;
   var torpDamage = 30;
   var collideTorp = F3(function (vessel,
   torp,
   _v22) {
      return function () {
         switch (_v22.ctor)
         {case "_Tuple3":
            return A2(isColliding,
              ...
              torp) ? {ctor: "_Tuple3"
                      ,_0: _v22._0
                      ,_1: torpDamage + _v22._1
                      ,_2: A2($List._op["::"],
                      createBoom(torp),
                      _v22._2)} : {ctor: "_Tuple3"
                                  ,_0: A2($List._op["::"],
                                  torp,
                                  _v22._0)
                                  ,_1: _v22._1
   ...
   var torpAcc = 500;
   var torpSpeed = 200;
   var torpSpawn = function (shooter) {
      return function () {
         var vec = getVec(shooter.a);
         return {_: {}
                ,a: 0
                ,age: 0
                ,drag: torpDrag
   ...
   var torpMaxAge = 0.9;
   var moveTorp = F3(function (t,
   vessel,
   torp) {
      return function () {
         var age$ = torp.age + t;
         return _U.cmp(age$,
         torpMaxAge) > 0 ? $Maybe.Nothing : function () {
            var a$ = A2(faceObj,
            torp,
            vessel);
            return $Maybe.Just(dragObj(t)(moveObj(t)(A2(accObj,
            t,
            torpAcc)(_U.replace([["age"
                                 ,age$]
                                ,["a",a$]],
            torp)))));
         }();
   ...
   var activate = function (ar) {
      return _U.replace([["rel"
                         ,ar.del]
                        ,["cur",ar.cur - ar.cost]],
      ar);
   };
   var applyBlink = function (vessel) {
      return function () {
         var children = vessel.children;
         var vec = getVec(F2(function (x,
         y) {
            return x * y;
         })($Basics.pi)(quickRange(vessel.x * vessel.y * vessel.a)));
         var $ = {ctor: "_Tuple2"
                 ,_0: vessel.x + vec.x * vessel.blinks.dist
                 ,_1: vessel.y + vec.y * vessel.blinks.dist},
         x$ = $._0,
         y$ = $._1;
         var $ = {ctor: "_Tuple2"
                 ,_0: A2(createFlash,
         ...
         flash1 = $._0,
         flash2 = $._1;
         var children$ = _U.replace([["flashes"
                                     ,A2($List._op["::"],
                                     flash1,
                                     A2($List._op["::"],
                                     flash2,
         ...
         return _U.replace([["x",x$]
                           ,["y",y$]
                           ,["blinks"
                            ,activate(vessel.blinks)]
                           ,["children",children$]],
         vessel);
      }();
   };
   var canActivate = function (ar) {
      return _U.cmp(ar.rel,
      0) > 0 ? false : _U.cmp(ar.cost,
      ar.cur) > 0 ? false : true;
   };
   var fireTorp = F2(function (game,
   vessel) {
      return function () {
         var torpWpn = vessel.torp;
         var canFire = function (vessel) {
            return $Basics.not(vessel.controls.fireT) ? false : canActivate(torpWpn) ? true : false;
         };
         var reallyFireTorp = F2(function (vessel,
         target) {
            return {ctor: "_Tuple2"
                   ,_0: {ctor: "_Tuple2"
                        ,_0: vessel.id
         ...
         return $Basics.not(canFire(vessel)) ? $Maybe.Nothing : function () {
            var _v27 = A2(maybeGetVessel,
            game,
            vessel.controls.tarID);
            switch (_v27.ctor)
            {case "Just":
               return $Maybe.Just(A2(reallyFireTorp,
                 vessel,
                 _v27._0));
               case "Nothing":
               return $Maybe.Nothing;}
            _U.badCase($moduleName,
            "between lines 979 and 981");
         }();
      }();
   });
   var fireTorps = F2(function (input,
   game) {
      return function () {
         var $ = $List.unzip($List.filterMap(fireTorp(game))($Dict.values(game.vessels))),
         shooters = $._0,
         newTorps = $._1;
         var vessels$ = A2($Dict.union,
         $Dict.fromList(shooters),
         game.vessels);
         var vessels$$ = A3($List.foldl,
         attachTorpedoes,
         vessels$,
         newTorps);
         return _U.replace([["vessels"
                            ,vessels$$]],
         game);
      }();
   });
   var fireBeam = F2(function (game,
   vessel) {
      return function () {
         var beamWpn = vessel.beam;
         var canFire = function (vessel) {
            return $Basics.not(vessel.controls.fireB) ? false : canActivate(beamWpn) ? true : false;
         };
         var canHit = F2(function (vessel,
         target) {
            return _U.cmp(A2(distance,
            vessel,
            target),
            beamWpn.range) > 0 ? false : _U.cmp($Basics.abs(A2(faceObj,
            vessel,
            target) - vessel.a),
            beamWpn.arc) > 0 ? false : true;
         });
         var reallyFireBeam = F2(function (vessel,
         target) {
            return {ctor: "_Tuple2"
                   ,_0: {ctor: "_Tuple2"
                        ,_0: vessel.id
         ...
         return $Basics.not(canFire(vessel)) ? $Maybe.Nothing : function () {
            var _v29 = A2(maybeGetVessel,
            game,
            vessel.controls.tarID);
            switch (_v29.ctor)
            {case "Just":
               return $Basics.not(A2(canHit,
                 vessel,
                 _v29._0)) ? $Maybe.Nothing : $Maybe.Just(A2(reallyFireBeam,
                 vessel,
                 _v29._0));
               case "Nothing":
               return $Maybe.Nothing;}
            _U.badCase($moduleName,
            "between lines 1034 and 1037");
         }();
      }();
   });
   var stepAct = F2(function (t,
   act) {
      return _U.replace([["rel"
                         ,$Basics.max(0)(act.rel - t)]],
      act);
   });
   var Activator = F4(function (a,
   b,
   c,
   d) {
   ...
   var applyDmg = F2(function (dmg,
   vessel) {
      return function () {
         var shields = vessel.shields;
         var harm = $Basics.max(0)(dmg - shields.def);
         var shields$ = _U.replace([["cur"
                                    ,shields.cur - harm]],
         shields);
         return _U.replace([["shields"
                            ,shields$]],
         vessel);
      }();
   });
   var updateTorpSeekingVessel = F3(function (t,
   id,
   vessel) {
      return function () {
         var seekedBy$ = A2($List.filterMap,
         A2(moveTorp,t,vessel),
         vessel.seekedBy);
         var $ = A3($List.foldl,
         collideTorp(vessel),
         {ctor: "_Tuple3"
         ...
         booms$ = $._2;
         var children = vessel.children;
         var children$ = _U.replace([["booms"
                                     ,A2($Basics._op["++"],
                                     children.booms,
                                     booms$)]],
         children);
         var vessel$ = _U.replace([["children"
                                   ,children$]
                                  ,["seekedBy",seekedBy$$]],
         vessel);
         return _U.eq(dmg,
         0) ? vessel$ : canActivate(vessel$.blinks) ? applyBlink(vessel$) : applyDmg(dmg)(vessel$);
      }();
   });
   var updateTorps = F2(function (input,
   game) {
      return function () {
         var vessels$ = A2($Dict.map,
         updateTorpSeekingVessel(input.tick),
         game.vessels);
         return _U.replace([["vessels"
                            ,vessels$]],
         game);
   ...
   var attachBeams = F2(function (_v31,
   vessels) {
      return function () {
         switch (_v31.ctor)
         {case "_Tuple3":
            switch (_v31._2.ctor)
              {case "_Tuple2":
                 return function () {
                      ...
                      {case "Just":
                         return function () {
                              var children = _v38._0.children;
                              var vessel$ = canActivate(_v38._0.blinks) ? function () {
                                 var children$ = _U.replace([["beams"
                                                             ,A2($List._op["::"],
                                                             _v31._2._1,
                                                             children.beams)]],
                                 children);
                                 return applyBlink(_U.replace([["children"
                                                               ,children$]],
                                 _v38._0));
                              }() : function () {
                                 var children$ = _U.replace([["beams"
                                                            ...
                                                            ,["booms"
                                                             ...
                                                             children.booms)]],
                                 children);
                                 return applyDmg(_v31._1)(_U.replace([["children"
                                                                      ,children$]],
                                 _v38._0));
                              }();
                              return A3($Dict.insert,
   ...
   var fireBeams = F2(function (input,
   game) {
      return function () {
         var $ = $List.unzip($List.filterMap(fireBeam(game))($Dict.values(game.vessels))),
         shooters = $._0,
         beams = $._1;
         var vessels$ = A2($Dict.union,
         $Dict.fromList(shooters),
   ...
   var stepReg = F2(function (t,
   reg) {
      return _U.replace([["cur"
                         ,$Basics.min(reg.max)(reg.cur + reg.reg * t)]],
      reg);
   });
   var stepShields = F2(function (t,
   vessel) {
      return _U.replace([["shields"
                         ,stepReg(t)(vessel.shields)]],
      vessel);
   });
   var stepActReg = F2(function (t,
   ar) {
      return stepAct(t)(A2(stepReg,
      t,
      ar));
   });
   var stepBlinks = F2(function (t,
   vessel) {
      return _U.replace([["blinks"
                         ,stepActReg(t)(vessel.blinks)]],
      vessel);
   });
   var stepTorpWpn = F2(function (t,
   vessel) {
      return _U.replace([["torp"
                         ,stepActReg(t)(vessel.torp)]],
      vessel);
   });
   var stepBeamWpn = F2(function (t,
   vessel) {
      return _U.replace([["beam"
                         ,stepActReg(t)(vessel.beam)]],
      vessel);
   });
   var Regenerator = F4(function (a,
   b,
   c,
   d) {
      return _U.insert("reg",
      c,
      _U.insert("max",
      b,
      _U.insert("cur",a,d)));
   });
   var playerShields = A3(Regenerator,
   150,
   150,
   5)({_: {},def: 5});
   var pirateShields = A3(Regenerator,
   60,
   60,
   2)({_: {},def: 2});
   var transportShields = A3(Regenerator,
   70,
   70,
   2)({_: {},def: 3});
   var playerBlinks = A3(Activator,
   1,
   1,
   1)(A3(Regenerator,
   2,
   ...
   1,
   0.15)({_: {},dist: 40}));
   var transportBlinks = A3(Activator,
   1,
   1,
   1)(A3(Regenerator,
   1,
   ...
   -1,
   0)({_: {},number: 0}));
   var transportFlares = A3(Activator,
   1,
   1,
   1)(A3(Regenerator,
   2,
   2,
   0.5)({_: {},number: 1}));
   var noTpWpn = A3(Activator,
   1,
   1,
   1)(A3(Regenerator,0,0,0)({_: {}
                            ,acc: 0
                            ,dmg: 0
                            ,life: 0
                            ,vel: 0}));
   var playerTpWpn = A3(Activator,
   0.3,
   0.3,
   1)(A3(Regenerator,5,5,1)({_: {}
                            ,acc: 800
                            ,dmg: 30
                            ,life: 1.0
                            ,vel: 100}));
   var pirateTpWpn = A3(Activator,
   1,
   1,
   1)(A3(Regenerator,1,1,1)({_: {}
                            ,acc: 800
                            ,dmg: 30
                            ,life: 0.8
                            ,vel: 100}));
   var noBmWpn = A3(Activator,
   1,
   1,
   1)(A3(Regenerator,0,0,0)({_: {}
                            ,arc: 0
   ...
   1)(A3(Regenerator,5,5,1)({_: {}
                            ...
                            ,dmg: 10
                            ,range: 200}));
   var transportBmWpn = A3(Activator,
   1.5,
   1.5,
   3)(A3(Regenerator,
   10,
   ...
   1)({_: {}
      ...
      ,dmg: 10
      ,range: 150}));
   var Runner = {ctor: "Runner"};
   var Attacker = {ctor: "Attacker"};
   var Player = {ctor: "Player"};
   var VesselJumped = {ctor: "VesselJumped"};
   var VesselDead = {ctor: "VesselDead"};
   var cullVessels = function (game) {
      return function () {
         var eph = game.ephemera;
         var f = F2(function (id,
         vessel) {
            return _U.eq(vessel.state,
            VesselDead);
         });
         ...
         culled = $._0,
         vessels$ = $._1;
         var newBooms = $List.map(createBoom)($Dict.values(culled));
         var eph$ = _U.replace([["booms"
                                ,A2($Basics._op["++"],
                                newBooms,
                                eph.booms)]],
         eph);
   ...
   var VesselInactive = {ctor: "VesselInactive"};
   var VesselActive = {ctor: "VesselActive"};
   var stepVesselState = function (vessel) {
      return function () {
         var state$ = _U.cmp(vessel.shields.cur,
         0) < 0 ? VesselDead : VesselActive;
   ...
   var initControls = {_: {}
                      ...
                      ,x: 0
                      ,y: 0};
   var ControlState = F6(function (a,
   b,
   c,
   d,
   e,
   ...
   var initChildren = {_: {}
                      ,beams: _L.fromArray([])
                      ,booms: _L.fromArray([])
                      ,flashes: _L.fromArray([])};
   var clearEphemera = function (vessel) {
      return _U.replace([["children"
                         ,initChildren]],
      vessel);
   };
   var updateVessel = F4(function (input,
   game,
   id,
   vessel) {
      return function () {
         var controls = vessel.controls;
         var acc = _U.cmp(controls.y,
         0) > 0 ? vessel.thrust : _U.cmp(controls.y,
         0) < 0 ? vessel.retro : 0;
         var va = controls.x * vessel.turn;
         var t = input.tick;
         return clearEphemera(stepTorpWpn(t)(stepBeamWpn(t)(stepBlinks(t)(stepShields(t)(stepVesselState(dragObj(t)(moveObj(t)(A2(accObj,
         t,
         acc)(A2(rotObj,
         t,
         va)(vessel))))))))));
   ...
   var updateVessels = F2(function (input,
   game) {
      return _U.replace([["vessels"
                         ,A2($Dict.map,
                         A2(updateVessel,input,game),
                         game.vessels)]],
      game);
   });
   var Children = F3(function (a,
   b,
   c) {
      return {_: {}
             ,beams: c
   ...
   var transportDrive = {_: {}
                        ,retro: -30
                        ,thrust: 60
                        ,turn: $Basics.degrees(80)};
   var pirateDrive = {_: {}
                     ,retro: -50
                     ,thrust: 80
                     ,turn: $Basics.degrees(90)};
   var playerDrive = {_: {}
                     ,retro: -50
                     ,thrust: 100
                     ,turn: $Basics.degrees(100)};
   var Drive = F3(function (a,
   b,
   c) {
      return {_: {}
             ,retro: b
   ...
   var neptuneWorld = function () {
      var view = $Graphics$Collage.toForm(A3($Graphics$Element.image,
      100,
      100,
      "images/3D_Neptune2.png"));
      return {_: {}
             ,dock: false
             ,kick: false
             ,view: view
   ...
   var createKickPt = neptuneWorld;
   var startingNavPts = _L.fromArray([neptuneWorld]);
   var NavPt = F5(function (a,
   b,
   c,
   d,
   e) {
   ...
   var merchantFact = 3;
   var newTransport = F2(function (_v40,
   id) {
      return function () {
         switch (_v40.ctor)
         {case "_Tuple2": return {_: {}
                                 ...
                                 ,y: _v40._1};}
         _U.badCase($moduleName,
         "between lines 319 and 333");
      }();
   });
   var maybeSpawnTransport = F3(function (game,
   nextID,
   newVessels) {
      return function () {
         var prob = quickProb(game.time * 7);
         return _U.cmp(prob,
         0.5) > 0 ? {ctor: "_Tuple2"
                    ,_0: nextID
                    ,_1: newVessels} : function () {
            var nextID$ = nextID + 1;
            var newVessel = A2(newTransport,
            {ctor: "_Tuple2"
            ,_0: quickRange(game.time * 5)
            ,_1: quickRange(game.time * 3)},
            nextID$);
            return {ctor: "_Tuple2"
                   ,_0: nextID$
                   ,_1: A2($List._op["::"],
   ...
   var pirateFact = 2;
   var newPirate = F2(function (_v44,
   id) {
      return function () {
         switch (_v44.ctor)
         {case "_Tuple2": return {_: {}
                                 ...
                                 ,y: _v44._1};}
         _U.badCase($moduleName,
         "between lines 298 and 312");
      }();
   });
   var initPirate = A2(newPirate,
   {ctor: "_Tuple2",_0: 0,_1: 0},
   2);
   var maybeSpawnPirate = F3(function (game,
   nextID,
   newVessels) {
      return function () {
         var prob = quickProb(game.time * 17);
         return _U.cmp(prob,
         0.7) > 0 ? {ctor: "_Tuple2"
                    ,_0: nextID
                    ,_1: newVessels} : function () {
            var nextID$ = nextID + 1;
            var newVessel = A2(newPirate,
            {ctor: "_Tuple2"
            ,_0: quickRange(game.time * 5)
            ,_1: quickRange(game.time * 3)},
            nextID$);
   ...
   game) {
      ...
      input.time) ? game : function () {
         var $ = A3(maybeSpawnTransport,
         game,
         game.nextID,
         _L.fromArray([])),
         nextID$ = $._0,
         newVessels = $._1;
         var $ = A3(maybeSpawnPirate,
         game,
         nextID$,
         newVessels),
         nextID$$ = $._0,
         ...
         return _U.replace([["time"
                           ...
                           ,["nextID",nextID$$]
                           ,["vessels"
                            ,$Dict.union(game.vessels)($Dict.fromList(newVessels$))]],
         game);
      }();
   });
   var playerFact = 1;
   var playerDict = $Dict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                 ,_0: playerFact
                                                 ,_1: false}
                                                ,{ctor: "_Tuple2"
                                                 ,_0: pirateFact
                                                ...
                                                ,{ctor: "_Tuple2"
                                                 ,_0: merchantFact
                                                 ,_1: false}]));
   var pirateDict = $Dict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                 ,_0: playerFact
                                                 ,_1: true}
                                                ,{ctor: "_Tuple2"
                                                 ,_0: pirateFact
                                                ...
                                                ,{ctor: "_Tuple2"
                                                 ,_0: merchantFact
                                                 ,_1: true}]));
   var merchantDict = $Dict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                   ,_0: playerFact
                                                   ,_1: false}
                                                  ,{ctor: "_Tuple2"
                                                   ,_0: pirateFact
                                                  ...
                                                  ,{ctor: "_Tuple2"
                                                   ,_0: merchantFact
                                                   ,_1: false}]));
   var hostilityDict = $Dict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                    ,_0: playerFact
                                                    ,_1: playerDict}
                                                   ,{ctor: "_Tuple2"
                                                    ,_0: pirateFact
                                                   ...
                                                   ,{ctor: "_Tuple2"
                                                    ,_0: merchantFact
                                                    ,_1: merchantDict}]));
   var isHostile = F2(function (ves1,
   ves2) {
      return function () {
         var _v48 = A2($Dict.get,
         ves1.faction,
         hostilityDict);
         switch (_v48.ctor)
         {case "Just":
            return function () {
                 ...
                 _v48._0);
                 switch (_v50.ctor)
                 {case "Just": return _v50._0;
                    case "Nothing": return false;}
                 _U.badCase($moduleName,
                 "between lines 680 and 682");
              }();
            case "Nothing": return false;}
         _U.badCase($moduleName,
         "between lines 677 and 682");
      }();
   });
   var getNearestHostile = F2(function (game,
   vessel) {
      return function () {
         var vessels = $Dict.values(game.vessels);
         var hostiles = A2($List.filter,
         isHostile(vessel),
         vessels);
         ...
         return function () {
            switch (sorted.ctor)
            {case "::":
               return $Maybe.Just(sorted._0);
               case "[]":
               return $Maybe.Nothing;}
            _U.badCase($moduleName,
            "between lines 693 and 695");
         }();
      }();
   });
   var ensureTarget = F3(function (game,
   vessel,
   target) {
      return function () {
         switch (target.ctor)
         {case "Just":
            return A2(getVessel,
              ...
              target._0);
            case "Nothing":
            return A2(getNearestHostile,
              game,
              vessel);}
         _U.badCase($moduleName,
         "between lines 851 and 853");
      }();
   });
   var updatePlayerControls = F3(function (input,
   game,
   vessel) {
      return function () {
         var controls = vessel.controls;
         var y = $Basics.toFloat(input.arrows.y);
         var x = $Basics.toFloat(input.arrows.x);
         var tarVessel = _U.eq(input.rKey,
         true) ? A2(getNearestHostile,
         game,
         vessel) : A3(ensureTarget,
         game,
         vessel,
         vessel.controls.tarID);
         var $ = function () {
            switch (tarVessel.ctor)
            {case "Just":
               return {ctor: "_Tuple3"
                      ,_0: input.shift
                      ,_1: input.space
                      ,_2: $Maybe.Just(tarVessel._0.id)};
               case "Nothing":
               return {ctor: "_Tuple3"
                      ,_0: false
                      ,_1: false
                      ,_2: $Maybe.Nothing};}
            _U.badCase($moduleName,
            "between lines 802 and 805");
         }(),
         fireT = $._0,
         fireB = $._1,
         tarID = $._2;
         var controls$ = _U.replace([["x"
                                     ,0 - x]
                                    ,["y",y]
                                    ,["fireT",fireT]
                                    ,["fireB",fireB]
                                    ,["tarID",tarID]],
         controls);
         return _U.replace([["controls"
                            ,controls$]],
         vessel);
      }();
   });
   var updateAttackerControls = F3(function (input,
   game,
   vessel) {
      return function () {
         var controls = vessel.controls;
         var tarVessel = A3(ensureTarget,
         game,
         vessel,
         vessel.controls.tarID);
         var $ = function () {
   ...
   var updateRunnerControls = F3(function (input,
   game,
   vessel) {
      return function () {
         var controls = vessel.controls;
   ...
   var updateControls = F4(function (input,
   game,
   id,
   vessel) {
      return function () {
         var _v63 = vessel.controls.brain;
         switch (_v63.ctor)
         {case "Attacker":
            return A3(updateAttackerControls,
              input,
              game,
              vessel);
            case "Player":
            return A3(updatePlayerControls,
              input,
              game,
              vessel);
            case "Runner":
            return A3(updateRunnerControls,
              input,
              game,
              vessel);}
         _U.badCase($moduleName,
         "between lines 788 and 791");
      }();
   });
   var updateVesselsControls = F2(function (input,
   game) {
      return function () {
         var vessels$ = A2($Dict.map,
         A2(updateControls,input,game),
         game.vessels);
         return _U.replace([["vessels"
                            ,vessels$]],
         game);
   ...
   game) {
      return timerSpawns(input)(cullVessels(updateCamera(collectEphemera(fireBeams(input)(fireTorps(input)(updateTorps(input)(updateEphemera(input)(updateVessels(input)(updateVesselsControls(input)(game))))))))));
   });
   var initPlayer = {_: {}
                    ,a: $Basics.pi
                    ,beam: playerBmWpn
                    ...
                    ,x: 0
                    ,y: 0};
   var startingVessels = $Dict.fromList(_L.fromArray([{ctor: "_Tuple2"
                                                      ,_0: 1
                                                      ,_1: initPlayer}
                                                     ,{ctor: "_Tuple2"
                                                      ,_0: 2
   ...
   gameW = $._0,
   gameH = $._1;
   var viewSky = $Graphics$Collage.filled($Color.black)(A2($Graphics$Collage.rect,
   gameW,
   gameH));
   var viewStarsImg = function (game) {
      return function () {
         var d = gameW * 5;
         var img = "images/test2.png";
         var $ = game.camera,
         cx = $._0,
         cy = $._1;
         var $ = {ctor: "_Tuple2"
         ...
         bx = $._0,
         by = $._1;
         var tiles = _L.fromArray([{ctor: "_Tuple2"
                                   ,_0: $Basics.toFloat($Basics.floor(bx))
                                   ,_1: $Basics.toFloat($Basics.floor(by))}
                                  ,{ctor: "_Tuple2"
                                   ,_0: $Basics.toFloat($Basics.floor(bx))
                                   ,_1: $Basics.toFloat($Basics.ceiling(by))}
                                  ,{ctor: "_Tuple2"
                                   ,_0: $Basics.toFloat($Basics.ceiling(bx))
                                   ,_1: $Basics.toFloat($Basics.floor(by))}
                                  ,{ctor: "_Tuple2"
                                   ,_0: $Basics.toFloat($Basics.ceiling(bx))
                                   ,_1: $Basics.toFloat($Basics.ceiling(by))}]);
         var drawTile = function (_v64) {
            return function () {
               switch (_v64.ctor)
               {case "_Tuple2":
                  return $Graphics$Collage.move({ctor: "_Tuple2"
                                                ,_0: d * _v64._0 - cx
                                                ,_1: d * _v64._1 - cy})($Graphics$Collage.toForm(A3($Graphics$Element.image,
                    d,
                    d,
                    img)));}
               _U.badCase($moduleName,
               "between lines 1230 and 1231");
            }();
         };
   ...
   var tileL = A2($Basics.max,
   halfW,
   halfH) * 2;
   var viewPanes = function (game) {
      return function () {
         var _v68 = A2(getVessel,
         game,
         game.playerID);
         switch (_v68.ctor)
         {case "Just":
            return function () {
                 var txy = {ctor: "_Tuple2"
                           ,_0: 150 - halfW
                           ,_1: 10 - halfH};
                 var targetPane = function () {
                    var _v70 = A2(maybeGetVessel,
                    game,
                    _v68._0.controls.tarID);
                    switch (_v70.ctor)
                    {case "Just":
                       return A2(drawVesselPane,
                         _v70._0,
                         txy);
                       case "Nothing":
                       return $Graphics$Collage.toForm($Graphics$Element.empty);}
                    _U.badCase($moduleName,
                    "between lines 1357 and 1360");
                 }();
                 var pxy = {ctor: "_Tuple2"
                           ,_0: 150 - halfW
                           ,_1: halfH - 10};
                 var playerPane = A2(drawVesselPane,
                 _v68._0,
                 pxy);
                 return $Graphics$Collage.group(_L.fromArray([playerPane
                                                             ,targetPane]));
              }();
            case "Nothing":
            return $Graphics$Collage.toForm($Graphics$Element.empty);}
         _U.badCase($moduleName,
         "between lines 1349 and 1361");
      }();
   };
   var drawMiniMap = function (game) {
      return function () {
         var color = function (vessel) {
            return function () {
               var _v72 = vessel.faction;
               switch (_v72)
               {case 1:
         ...
         cx = $._0,
         cy = $._1;
         var dist = $Basics.sqrt(Math.pow(cx,
         2) + Math.pow(cy,2));
         var scale = _U.cmp(dist,
         2000) < 0 ? 3000 : _U.cmp(dist,
         5000) < 0 ? 7500 : _U.cmp(dist,
         10000) < 0 ? 15000 : _U.cmp(dist,
         20000) < 0 ? 30000 : _U.cmp(dist,
         50000) < 0 ? 75000 : 300000.0;
         var f2 = function (_v73) {
            return function () {
               switch (_v73.ctor)
               {case "_Tuple3":
                  return _U.cmp($Basics.abs(_v73._1),
                    scale) > 0 || _U.cmp($Basics.abs(_v73._2),
                    scale) > 0 ? $Maybe.Nothing : $Maybe.Just($Graphics$Collage.move({ctor: "_Tuple2"
                                                                                     ,_0: _v73._1 / scale * size
                                                                                     ,_1: _v73._2 / scale * size})($Graphics$Collage.filled(_v73._0)($Graphics$Collage.circle(2))));}
               _U.badCase($moduleName,
               "between lines 1397 and 1399");
            }();
         };
         var dots = $Graphics$Collage.group($List.filterMap(f2)($List.map(f1)($Dict.values(game.vessels))));
         return $Graphics$Collage.move({ctor: "_Tuple2"
                                       ,_0: halfW - size - 5
                                       ,_1: halfH - size - 5})($Graphics$Collage.alpha(0.5)($Graphics$Collage.group(_L.fromArray([$Graphics$Collage.filled($Color.charcoal)($Graphics$Collage.square(size * 2))
                                                                                                                                 ,dots]))));
      }();
   };
   var view = F2(function (_v78,
   game) {
      return function () {
         switch (_v78.ctor)
         {case "_Tuple2":
   ...
   $Window.dimensions),
   foldGame);
   _elm.Asteroids2.values = {_op: _op
                            ,main: main
                            ,foldGame: foldGame
                            ,allInputs: allInputs
                            ,tick: tick
                            ...
                            ,pirateFact: pirateFact
                            ,merchantFact: merchantFact
                            ,playerDict: playerDict
                            ,pirateDict: pirateDict
                            ,merchantDict: merchantDict
                            ,hostilityDict: hostilityDict
                            ,Game: Game
                            ,startGame: startGame
                            ,NavPt: NavPt
                            ,startingNavPts: startingNavPts
                            ,neptuneWorld: neptuneWorld
                            ,createKickPt: createKickPt
                            ,Object: Object
                            ,initPlayer: initPlayer
                            ,initPirate: initPirate
                            ,newPirate: newPirate
                            ,newTransport: newTransport
                            ,startingVessels: startingVessels
                            ,Drive: Drive
                            ,playerDrive: playerDrive
                            ,pirateDrive: pirateDrive
                            ...
                            ,VesselInactive: VesselInactive
                            ,VesselDead: VesselDead
                            ,VesselJumped: VesselJumped
                            ,Player: Player
                            ,Attacker: Attacker
                            ,Runner: Runner
                            ...
                            ,pirateShields: pirateShields
                            ,transportShields: transportShields
                            ,stepShields: stepShields
                            ,applyDmg: applyDmg
                            ,Activator: Activator
                            ,stepAct: stepAct
                            ,stepActReg: stepActReg
                            ,canActivate: canActivate
                            ,activate: activate
                            ,playerBlinks: playerBlinks
                            ,pirateBlinks: pirateBlinks
                            ,transportBlinks: transportBlinks
                            ,stepBlinks: stepBlinks
                            ,applyBlink: applyBlink
                            ,playerFlares: playerFlares
                            ,noFlares: noFlares
                            ,transportFlares: transportFlares
                            ,noTpWpn: noTpWpn
                            ,playerTpWpn: playerTpWpn
                            ,pirateTpWpn: pirateTpWpn
                            ,stepTorpWpn: stepTorpWpn
                            ,noBmWpn: noBmWpn
                            ,playerBmWpn: playerBmWpn
                            ,transportBmWpn: transportBmWpn
                            ,stepBeamWpn: stepBeamWpn
                            ,torpMaxAge: torpMaxAge
                            ,torpSpeed: torpSpeed
                            ,torpAcc: torpAcc
                            ,torpDrag: torpDrag
                            ,torpReload: torpReload
                            ,torpDamage: torpDamage
                            ,torpDetRadius: torpDetRadius
                            ,Beam: Beam
                            ,beamMaxAge: beamMaxAge
                            ,boomMaxAge: boomMaxAge
                            ,boomGrowthRate: boomGrowthRate
                            ,boomInitRadius: boomInitRadius
                            ,flashMaxAge: flashMaxAge
                            ,flashShrinkRate: flashShrinkRate
                            ,flashInitRadius: flashInitRadius
                            ,quickProb: quickProb
                            ,quickRange: quickRange
                            ,getVessel: getVessel
                            ,maybeGetVessel: maybeGetVessel
                            ,isHostile: isHostile
                            ,getNearestHostile: getNearestHostile
                            ,wrapAngle: wrapAngle
                            ,moveObj: moveObj
                            ,dragObj: dragObj
                            ,accObj: accObj
                            ...
                            ,updateVesselsControls: updateVesselsControls
                            ,updateControls: updateControls
                            ,updatePlayerControls: updatePlayerControls
                            ,updateAttackerControls: updateAttackerControls
                            ,updateRunnerControls: updateRunnerControls
                            ,ensureTarget: ensureTarget
                            ,updateVessels: updateVessels
                            ,updateVessel: updateVessel
                            ,stepVesselState: stepVesselState
                            ,clearEphemera: clearEphemera
                            ,updateTorps: updateTorps
                            ,updateTorpSeekingVessel: updateTorpSeekingVessel
                            ,moveTorp: moveTorp
                            ,collideTorp: collideTorp
                            ,blinkJump: blinkJump
                            ...
                            ,fireTorp: fireTorp
                            ,torpSpawn: torpSpawn
                            ,attachTorpedoes: attachTorpedoes
                            ,fireBeams: fireBeams
                            ,fireBeam: fireBeam
                            ,createBeam: createBeam
                            ,attachBeams: attachBeams
                            ,updateEphemera: updateEphemera
                            ,collectEphemera: collectEphemera
                            ,updateCamera: updateCamera
                            ,cullVessels: cullVessels
                            ,timerSpawns: timerSpawns
                            ,maybeSpawnTransport: maybeSpawnTransport
                            ,maybeSpawnPirate: maybeSpawnPirate
                            ,view: view
                            ,viewSky: viewSky
                            ,viewStarsImg: viewStarsImg
                            ,viewPlanet: viewPlanet
                            ,viewBeams: viewBeams
                            ,viewTorpedoes: viewTorpedoes
                            ,viewVessels: viewVessels
                            ,viewVessel: viewVessel
                            ,viewBooms: viewBooms
                            ,viewFlashes: viewFlashes
                            ,drawText: drawText
                            ,viewText: viewText
                            ,viewPanes: viewPanes
                            ,drawVesselPane: drawVesselPane
